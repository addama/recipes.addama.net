...
def build_index_page():
	html = [
		...
		'</h1>',
		'<h2>Overview</h2>',
		'<p>This site contains recipes used in my household, as well as transcribed and interpreted recipes from a family cookbook spanning at least 3 generations. The pages are generated by a python script on the fly.</p>',
		'<h2>Tags</h2>',
		'<div id="indexTagList">'
	]
