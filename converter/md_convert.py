...
def build_base_page(title, content, isIndex=False):
	...
	html = [
		...
		'<link href="https://fonts.googleapis.com/css2?family=Crimson+Pro:wght@200&family=El+Messiri:wght@700&family=The+Nautigal:wght@700&display=swap" rel="stylesheet">',
